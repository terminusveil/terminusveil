    ...
    <DeskShell desk={desk}>
      <main className="wrap max-w-3xl py-12 sm:py-16">
        ...
        <div className="mt-8 space-y-4 text-sm leading-relaxed text-ink-muted">
          <p>
            This desk reads public chain data and the issuer's public stock-token API. It does
            not collect accounts, emails, or wallet connections on this surface.
          </p>
          <p>
            Tape, multipliers, and corporate-action rows are fetched server-side from public
            endpoints and shown as returned. When a source does not answer, the desk serves its
            last committed reading, captioned with its read time and block, and writes absent
            where that reading has nothing. It never guesses a figure. It does not store visitor
            identifiers.
          </p>
          <p>
            An open tab polls the desk every 45 seconds while the page stays open. An ICS
            calendar subscription is a public URL with no identifiers beyond the ticker you
            chose; whatever calendar app you point at it fetches that URL directly.
          </p>
          <p>
